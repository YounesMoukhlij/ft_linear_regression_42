...
def main() -> None:
    with open('../data.csv', 'r') as file:
        ...
        # First plot: Raw data distribution
        plt.subplot(1, 2, 1)
        ...
        # Second plot: Regression line with sorted data
        plt.subplot(1, 2, 2)
